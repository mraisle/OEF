...
Liz$Key.Author <- as.character("Emily Jones")
Liz$All.Authors <- as.character("")

#remove bad row pulls from google 

clean_Liz <- Liz[!grepl("author", Liz$url),]
clean_Liz <- clean_Liz[!grepl("News Articles", clean_Liz$title),]
clean_Liz <- clean_Liz[!grepl("obituar", clean_Liz$url),]
clean_Liz <- clean_Liz[!grepl("WABE's", clean_Liz$title),]
clean_Liz <- clean_Liz[!grepl("Nice try", clean_Liz$title),]
clean_Liz <- clean_Liz[!grepl("greensboro.com", clean_Liz$source),]
clean_Liz <- clean_Liz[!grepl("Coverage", clean_Liz$title),]
clean_Liz <- clean_Liz[!grepl("coverage", clean_Liz$title),]
clean_Liz <- clean_Liz[!grepl("cousin", clean_Liz$title),]
clean_Liz <- clean_Liz[!grepl("wral", clean_Liz$source),]
clean_Liz <- clean_Liz[!grepl("starnews", clean_Liz$source),]
clean_Liz <- clean_Liz[!grepl("journalnow", clean_Liz$source),]
clean_Liz <- clean_Liz[!grepl("gaston", clean_Liz$source),]
